...
class Cliente(OtifModel):
    ...
    hr_lim_carga = models.CharField('Limite de atraso de carregamento (hs)', max_length=5, null='true', blank='true', )
    hr_lim_lib = models.CharField('Limite de atraso de liberação (hs)', max_length=5, null='true', blank='true', )
